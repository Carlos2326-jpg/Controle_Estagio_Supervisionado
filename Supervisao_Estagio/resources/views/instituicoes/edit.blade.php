...
<body>
    ...
    <form action="{{ route('instituicoes.update', $instituicao->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nome_instituicao" value="{{ old('nome_instituicao', $instituicao->nome_instituicao) }}" required>
        ...
        <div class="form-group">
            ...
            <input type="text" name="estado" value="{{ old('estado', $instituicao->estado) }}" maxlength="2" required>
