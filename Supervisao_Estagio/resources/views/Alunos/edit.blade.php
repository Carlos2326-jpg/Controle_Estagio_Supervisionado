        ...
        <form method="POST" action="{{ route('alunos.update', $aluno) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $aluno->user->name) }}"
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email', $aluno->user->email) }}"
                           class="w-full border rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="cpf" value="{{ old('cpf', $aluno->cpf) }}" maxlength="11"
                           class="w-full border rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="telefone" value="{{ old('telefone', $aluno->telefone) }}" placeholder="(00) 00000-0000"
                           class="w-full border rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div class="flex gap-3 mt-6">
                <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 text-sm">Salvar</button>
                <a href="{{ route('alunos.show', $aluno) }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded hover:bg-gray-300 text-sm">Cancelar</a>
            </div>
        </form>
    </div>
@endsection
