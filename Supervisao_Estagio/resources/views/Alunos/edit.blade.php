        ...
        <form method="POST" action="{{ route('alunos.update', $aluno) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="periodo" value="{{ old('periodo', $aluno->periodo) }}" min="1" max="10"
                           class="w-full border rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                    @error('periodo')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" name="carga_horaria_obrigatoria" value="{{ old('carga_horaria_obrigatoria', $aluno->carga_horaria_obrigatoria) }}"
                           class="w-full border rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
